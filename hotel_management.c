...
int main()
{
    heada = createadmin(heada,1,"Chicken Roll",100);
    heada = createadmin(heada,2,"Chicken Egg Roll",120);
    heada = createadmin(heada,3,"Chicken Double Egg Roll",150);
    heada = createadmin(heada,4,"Aloo Roll",80);
    heada = createadmin(heada,5,"Paneer Roll",100);
